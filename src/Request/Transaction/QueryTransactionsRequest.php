...
class QueryTransactionsRequest extends Request
{
    ...
    protected $rules = [
        ...
        'cardLast4' => 'max:4',
        'cardBin' => 'max:6',
        'achAccountNumber' => 'digits:4',
        'achRoutingNumber' => 'digits:9',
        ...
        'startDate' => 'required_without:customerId,purchaseId,orderId',
        'endDate' => 'required_without:customerId,purchaseId,orderId',
