...
class ImportLeadRequest extends Request
{
    ...
    protected $rules = [
        ...
        'shipFirstName' => 'required_if:billShipSame,0|max:30',
        'shipLastName' => 'required_if:billShipSame,0|max:30',
        'shipCompanyName' => 'max:30',
        'shipAddress1' => 'required_if:billShipSame,0|max:30',
        'shipAddress2' => 'max:30',
        'shipPostalCode' => 'required_if:billShipSame,0|max:20',
        'shipCity' => 'required_if:billShipSame,0|max:30',
        'shipState' => 'required_if:billShipSame,0|max:6|valid_state_for_country:shipCountry',
        'shipCountry' => 'required_if:billShipSame,0|max:2',
